        ...
        if(isset($_GET['p']))
           ...
           if($params[0] != ''){
            ...
            // On vérifie si le controleur existe
               // On créé un tableau avec tous les controleurs existants
               $controllerArray = ['\App\Controllers\AdminController', '\App\Controllers\CommentController', '\App\Controllers\MainController', '\App\Controllers\PostController', '\App\Controllers\UserController' ];
               // On vérifie si le controleur demandé existe dans la liste des controleurs réels
