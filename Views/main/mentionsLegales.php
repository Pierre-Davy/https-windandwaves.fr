<main>
    ...
    <p>En vigueur au 12/05/2024</p>


    <p>Conformément aux dispositions des Articles 6-III et 19 de la Loi n°2004-575 du 21 juin 2004 pour la Confiance dans l’économie numérique, dite L.C.E.N., il est porté à la connaissance des utilisateurs et visiteurs, ci-après l'<strong>"Utilisateur"</strong>, du site https://windandwaves.fr , ci-après le <strong>"Site"</strong>, les présentes mentions légales.</p>
    ...
    <p>L’édition et la direction de la publication du Site est assurée par M. PIERRE D., en résidence à l'Afpa Brest - 15 rue du Petit Spernot 29200 BREST, dont l'adresse e-mail est admin@windandwaves.fr.</p>

    <h2>ARTICLE 2 - L'HEBERGEUR</h2>

    <p>L'hébergeur du Site est la société HOSTINGER INTERNATIONAL LTD, dont le siège social est situé au 61 Lordou Vironos Street, 6023 Larnaca, Chypre , https://www.hostinger.fr/contact.</p>
    ...
    <ul>
        <li>par mail à l'adresse email admin@windandwaves.fr ;</li>
